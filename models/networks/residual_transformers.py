...
class Attention(nn.Module):
    def __init__(self, vis, num_heads, hidden_size, dropout_rate):
...
class Mlp(nn.Module):
    def __init__(self, hidden_size, dropout_rate, mlp_dim):
...
class Embeddings(nn.Module):
    ...
    """
    def __init__(self, img_size, in_channels=3,input_dim=3,old = 1, hidden_size=None, grid=None, dropout_rate=None):
...
class Block(nn.Module):
    def __init__(self, vis, hidden_size, mlp_kwargs={}, attention_kwargs={}):
        super(Block, self).__init__()
        self.hidden_size = hidden_size
        self.attention_norm = LayerNorm(hidden_size, eps=1e-6)
        self.ffn_norm = LayerNorm(hidden_size, eps=1e-6)
        self.ffn = Mlp(hidden_size=hidden_size, **mlp_kwargs)
        self.attn = Attention(vis, **attention_kwargs)
...
class Encoder(nn.Module):
    def __init__(self, vis, hidden_size, num_layers, block_kwargs={}):
        super(Encoder, self).__init__()
        self.vis = vis
        self.layer = nn.ModuleList()
        self.encoder_norm = LayerNorm(hidden_size, eps=1e-6)
        for _ in range(num_layers):
            layer = Block(vis, **block_kwargs)
...
class ART_block(nn.Module):
    def __init__(self, input_dim, img_size=224,transformer = None, hidden_size=None, embedding_kwargs={}):
        ...
        if self.transformer:
            ...
            #Patch embedings
            self.embeddings = Embeddings(img_size=img_size, input_dim=input_dim, hidden_size=hidden_size, **embedding_kwargs)
            # Upsampling block
...
class ResViT(nn.Module):
    def __init__(self, input_dim, img_size=224, output_dim=3, vis=False, encoder_kwargs={}, block_kwargs={}):
        super(ResViT, self).__init__()
        self.transformer_encoder = Encoder(vis, **encoder_kwargs)
        ...
        ####################################ART Blocks##############################################
        mult = 4
        self.art_1 = ART_block(input_dim, img_size,transformer = self.transformer_encoder, **block_kwargs)
        self.art_2 = ART_block(input_dim, img_size,transformer = None, **block_kwargs)
        self.art_3 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_4 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_5 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_6 = ART_block(input_dim, img_size,transformer = self.transformer_encoder, **block_kwargs)
        self.art_7 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_8 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_9 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        ############################################################################################
        # Layer13-Decoder1
        n_downsampling = 2
        i = 0
...
class Res_CNN(nn.Module):
    def __init__(self, input_dim, img_size=224, output_dim=3, vis=False, encoder_kwargs={}, block_kwargs={}):
        ...
        ####################################ART Blocks##############################################
        mult = 4
        self.art_1 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_2 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_3 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_4 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_5 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_6 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_7 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_8 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        self.art_9 = ART_block(input_dim, img_size, transformer=None, **block_kwargs)
        ############################################################################################
