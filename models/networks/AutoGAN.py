...
class SearchSpace(nn.Module):
    ...
    def __init__(self, in_channel=12, list_channels=[32, 64, 128, 256], list_modules=[2,4,4,4]):
        ...
        self.final_conv = nn.Sequential(
            nn.Conv2d(list_channels[0], 1, 1, 1, bias=False)
        )
...
class HighResolutionNet(nn.Module):
    def __init__(self, ckt_path, in_channel=12, list_channels=[32, 64, 128, 256], list_modules=[2,4,4,4]):
