...
class DeepResolveModel(BaseModel):
    @staticmethod
    ...
    def backward_G(self):
        ...
        # Second, G(A) = B
        self.loss_G_L2 = self.criterionL2(self.fake_B, self.real_B) * self.opt.loss.lambda_L1
