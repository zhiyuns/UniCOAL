...
class Pix2PixModel(BaseModel):
    ...
    def set_input(self, input):
        ...
        self.label = input[self.opt.loaders.label_internal_path[0]].to(self.device) if self.sg or (not self.isTrain and self.eval_seg)  else None
